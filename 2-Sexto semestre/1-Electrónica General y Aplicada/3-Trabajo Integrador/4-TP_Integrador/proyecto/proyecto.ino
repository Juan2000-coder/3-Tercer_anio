...
#define buzzer 4 // el buzzer funcionará como alarma cuando se sobrepase el límite establecido
...
void loop() {
  ...
  if (velocidad >=limite){ //chequea si la velocidad del viento superó el límite. De ser así enciende la alarma, de lo contrario la mantiene apagada
